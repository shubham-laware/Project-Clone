...
const AddBlog = () => {
  ...
  return (
    ...
    >
      ...
      <Form className="container-sm d-flex flex-column gap-3">
        ...
        <Form.Group controlId="image_1">
          ...
          <Form.Control type="file" name="image_1" onChange={handleChange} />
        </Form.Group>
        ...
        <Form.Group controlId="image_2">
          ...
          <Form.Control type="file" name="image_2" onChange={handleChange} />
        </Form.Group>
        ...
        <Form.Group controlId="image_3">
          ...
          <Form.Control type="file" name="image_3" onChange={handleChange} />
        </Form.Group>
