    ...
    <div className='container py-5  ' style={{marginTop: 150}}>
      <div className='row'>
        <div className='col-md-6 text-dark'>
          <h3 className='text-center text-md-start display-5 '><strong>Connect with our team</strong></h3>
          <div className='py-4'>
            <p>Our Team is happy to answer your questions about our platform.</p>
            <ul className='list-unstyled text-secondary'>
              <li><i className='bi bi-check text-primary'></i> Discover how our ecommerce platform can enhance your business</li>
              <li><i className='bi bi-check text-primary'></i> Get pricing information tailored to your needs</li>
              <li><i className='bi bi-check text-primary'></i> Learn about other successful businesses using our ecommerce solutions</li>
            </ul>
          </div>
          <div className='border-top py-4'>
            <h2 className='text-center text-md-start text-secondary'>Leading Brands trust us for our services</h2>
            <div className='d-flex justify-content-center justify-content-md-start mt-4'>
              <img src={Logo} alt="zendesk" className='img-fluid w-25 img-thumbnail opacity-75' />
            </div>
          </div>
        </div>
